/**
 * Update chatbot general settings instructions.
 */
export const updateBotGeneralSettingInstructions: string = `"
...
/**
 * Clear chatbot data instructions.
 */
export const clearBotDataInstructions: string = `
...
/**
 * Set offline hours instructions.
 */
export const setOfflineHoursInstructions: string = `
...
/**
 * Create team member instructions.
 */
export const createTeamMemberInstructions: string = `
...
/**
 * Update team member instructions.
 */
export const updateTeamMemberInstructions: string = `
...
/**
 * Delete member instructions.
 */
export const deleteTeamMemberInstructions: string = `
...
/**
 * Create page messages instructions.
 */
export const createPageMessageInstructions: string = `
...
/**
 * update page message instructions.
 */
export const updatePageMessageInstructions: string = `
...
/**
 * Create chatbot menu instructions.
 */
export const createChatBotMenuInstructions: string = `
